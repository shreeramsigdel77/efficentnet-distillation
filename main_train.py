...
from model.data_loader import ImageTransform, TestDatasetLoader

from model.trainner import CustomModelTrainer
...
transform = ImageTransform(INPUT_IMG_SIZE)
...
for category in CATEGORIES:
    ...
    test_loader = TestDatasetLoader(
        ...
        batch_size=BATCH_SIZE,
        transform=transform).load()  # Call load() to get the DataLoader
